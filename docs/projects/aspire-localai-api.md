---
title: Nextended.Aspire.Hosting.LocalAI — API reference
---

# Nextended.Aspire.Hosting.LocalAI — API reference

🇩🇪 [Diese Seite auf Deutsch](/de/projects/aspire-localai-api)

The complete public surface of `Nextended.Aspire.Hosting.LocalAI`, generated from the compiled assembly.
...
↩ [Back to the package page](/projects/aspire-localai)
