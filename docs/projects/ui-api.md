---
title: Nextended.UI — API reference
---

# Nextended.UI — API reference

🇩🇪 [Diese Seite auf Deutsch](/de/projects/ui-api)

The complete public surface of `Nextended.UI`, generated from the compiled assembly.
...
↩ [Back to the package page](/projects/ui)
