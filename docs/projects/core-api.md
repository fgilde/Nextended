---
title: Nextended.Core — API reference
---

# Nextended.Core — API reference

🇩🇪 [Diese Seite auf Deutsch](/de/projects/core-api)

The complete public surface of `Nextended.Core`, generated from the compiled assembly.
...
↩ [Back to the package page](/projects/core)
