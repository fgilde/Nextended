---
title: Nextended.Aspire.Hosting.Supabase — API reference
---

# Nextended.Aspire.Hosting.Supabase — API reference

🇩🇪 [Diese Seite auf Deutsch](/de/projects/aspire-supabase-api)
...
↩ [Back to the package page](/projects/aspire-supabase)
