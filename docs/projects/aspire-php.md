...
**[Php.AppHost](https://github.com/fgilde/Nextended/tree/main/Tests/TestProjects/Php.AppHost)**
...
- 📄 [Package README](https://github.com/fgilde/Nextended/blob/main/Nextended.Aspire.Hosting.Php/README.md)
