...
```bash
dotnet add package Nextended.Aspire.Hosting.LocalAI
```
...
**[AiStack.AppHost](https://github.com/fgilde/Nextended/tree/main/Tests/TestProjects/AiStack.AppHost)**

```bash
git clone https://github.com/fgilde/Nextended.git
cd Nextended/Tests/TestProjects/AiStack.AppHost
dotnet run
```
...
[`Nextended.Aspire.Hosting.N8n`](https://github.com/fgilde/Nextended/tree/main/Nextended.Aspire.Hosting.N8n), wire the URL in and order startup:
...
- 📄 [Package README](https://github.com/fgilde/Nextended/blob/main/Nextended.Aspire.Hosting.LocalAI/README.md)
