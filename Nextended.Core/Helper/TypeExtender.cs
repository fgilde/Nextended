...
public class TypeExtender
{
    ...
    public TypeExtender(Type type, Type baseType = null) : this(type.Name, baseType ?? typeof(object))
    {}
    ...
    public void AddProperty<T>(string propertyName, IEnumerable<Tuple<Type, object[]>> attributesWithValues, bool isReadOnly = false)
    {
        ...
        InternalAddProperty(propertyName, typeof(T), attributesWithValues, isReadOnly);
    }
    ...
    public void AddProperty(string propertyName, Type propertyType, bool isReadOnly = false)
    {
        ...
        InternalAddProperty(propertyName, propertyType, null, null, isReadOnly);
    }
    ...
    public void AddProperty(string propertyName, Type propertyType, Type attributeType, object[] attributeValues, bool isReadOnly = false)
    {
        ...
        InternalAddProperty(propertyName, propertyType, attributeType, attributeValues, isReadOnly);
    }
        ...
        IEnumerable<Tuple<Type, object[]>> attributesWithValues, bool isReadOnly = false)
    {
        ...
        InternalAddProperty(propertyName, propertyType, attributesWithValues, isReadOnly);
    }
    ...
    public void AddProperty(IEnumerable<string> properties, IEnumerable<Type> types, bool allReadOnly)
    {
        ...
        {
            InternalAddProperty(properties.ElementAt(index).Replace(" ", "_"), types.ElementAt(index), null, null, allReadOnly);
        }
    }
    ...
    private void InternalAddProperty(string propertyName, Type type, Type attributeType, object[] attributeValues, bool isReadOnly)
    {
        InternalAddProperty(propertyName, type, new[] { new Tuple<Type, object[]>(attributeType, attributeValues) }, isReadOnly);
    }

    private void InternalAddProperty(string propertyName, Type type, IEnumerable<Tuple<Type, object[]>> attributeTypesWithValues, bool isReadOnly)
    {
        InitializeTypeConstruction();
