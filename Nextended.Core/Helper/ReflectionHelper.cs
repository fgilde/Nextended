...
namespace Nextended.Core.Helper
{
	...
	public static class ReflectionHelper
	{
        ...
        /// <summary>
        /// Instanz f�r interface erzeugen
        /// </summary>
        /// <typeparam name="TInterface">The type of the interface.</typeparam>
        /// <param name="coverUpAbstractMembers">Wenn true werden Abstrakte basis properties �berdeckt</param>
        /// <returns></returns>
		...
		/// <summary>
		/// PropertyInfo auch f�r parenttypes zur�ckgeben
		/// </summary>
		...
		/// <param name="coverUpAbstractMembers">Wenn true werden Abstrakte basis properties �berdeckt</param>
		/// <param name="tryResolve">Gibt an ob versucht werden soll per unity den typen aufzul�sen</param>
		...
		/// <summary>
		/// Gibt alle Properties mit wert zur�ck
		/// </summary>
		...
		/// <summary>
		/// Pr�ft ob ein bestimmter Typ ein bestimmtes interface implementiert
		/// </summary>
		...
		/// <summary>
		/// Gibt den wert einer Property eines Objektes zur�ck
		/// </summary>
		...
		/// <summary>
		/// Gibt die Methode zur�ck, von der der Aufruf der Methode, die "GetCallingMethod" aufgerufen hat kam
		/// </summary>
