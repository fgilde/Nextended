...
{
    public class ClonerProperty : IClonerProperty
    {
        ...
        public bool FastDeepClonerIgnore { get => ContainAttribute<ClonerIgnoreAttribute>(); }

        public bool FastDeepClonerPrimaryIdentifire { get => ContainAttribute<ClonerPrimaryIdentifire>(); }
        ...
        public Type PropertyType
        {
            ...
            set
            {
                if (CloneConfigrationManager.OnPropertTypeSet != null)
                    _propertyType = _propertyType = CloneConfigrationManager.OnPropertTypeSet?.Invoke(this);
        ...
        internal ClonerProperty(FieldInfo field)
        {
            ...
            CloneConfigrationManager.OnAttributeCollectionChanged?.Invoke(this);
        }

        internal ClonerProperty(PropertyInfo property)
        {
