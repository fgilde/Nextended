    ...
    internal static class ConvertToInterfaceTypeGenerator
    {
        ...
        public static Type Convert(Type interfaceType, Type type)
        {
            try
            {
                ...
                var props = Cloner.GetFastDeepClonerProperties(interfaceType);
        ...
        public static void CreateConstructor(List<IClonerProperty> props, TypeBuilder typeBuilder, List<FieldBuilder> fields)
        {
        ...
        public static List<FieldBuilder> CreateProperty(List<IClonerProperty> props, TypeBuilder typeBuilder)
        {
