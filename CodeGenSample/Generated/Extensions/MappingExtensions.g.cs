using Nextended.Core.Extensions;// <auto-generated /> (12.08.2025 13:43:52)
using System;
namespace MyGenerated.Code.Test {
	public static partial class MappingExtensions
	{
		...
		public static void AssignBaseProperties(this AbstractBaseClassDto dto, CodeGenSample.Entities.AbstractBaseClass src)
		{
			dto.Id = src.Id;
		}
		public static void AssignBaseProperties(this CodeGenSample.Entities.AbstractBaseClass entity, AbstractBaseClassDto dto)
		{
			entity.Id = dto.Id;
		}
		...
		public static MyGenerated.Code.Test.AbstractBaseClassDto ToDto(this CodeGenSample.Entities.AbstractBaseClass src) 
		{
			if(src == null) return null;
			var result = new MyGenerated.Code.Test.AbstractBaseClassDto();
			result.Id = src.Id;
			return result;
		}
		public static CodeGenSample.Entities.AbstractBaseClass ToNet(this MyGenerated.Code.Test.AbstractBaseClassDto src) 
		{
			if(src == null) return null;
			var result = new CodeGenSample.Entities.AbstractBaseClass();
			result.Id = src.Id;
			return result;
		}
		...
		public static MyGenerated.Code.Test.MyUserDto ToMyDto(this CodeGenSample.Entities.User src) 
		{
			...
			result.AnotherAddress = src.AnotherAddress?.ToMegaDto();
			result.XyZ = src.XyZ;
		...
		public static CodeGenSample.Entities.User ToNet(this MyGenerated.Code.Test.MyUserDto src) 
		{
			...
			result.AnotherAddress = src.AnotherAddress?.AsSrc();
			result.XyZ = src.XyZ;
		...
		public static MyGenerated.Code.Test.DerivedClassDto ToDto(this CodeGenSample.Entities.DerivedClass src) 
		{
			...
			(( AbstractBaseClassDto )result).AssignBaseProperties(src);
			result.Name = src.Name;
			return result;
		}
		public static CodeGenSample.Entities.DerivedClass ToNet(this MyGenerated.Code.Test.DerivedClassDto src) 
		{
			...
			result.AssignBaseProperties(( AbstractBaseClassDto )src);
			result.Name = src.Name;
			return result;
		}
