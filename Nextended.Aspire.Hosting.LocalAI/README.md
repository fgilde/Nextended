...
[![Downloads](https://img.shields.io/nuget/dt/Nextended.Aspire.Hosting.LocalAI.svg)](https://www.nuget.org/packages/Nextended.Aspire.Hosting.LocalAI/)
...
[![LocalAI](https://raw.githubusercontent.com/mudler/LocalAI/master/docs/assets/images/logos/logo.png)](https://localai.io/)

[![LocalAI screenshot](https://raw.githubusercontent.com/mudler/LocalAI/master/docs/assets/images/localai_screenshot.png)](https://localai.io/)

Runs **[LocalAI](https://localai.io/)** as an Aspire resource.
...
- **Nextended.Aspire.Hosting.LocalAI** — Self-hosted, OpenAI-compatible multimodal AI — image generation, text-to-speech, speech-to-text and video — with gallery model management, GPU support and Open WebUI. _(this package)_
