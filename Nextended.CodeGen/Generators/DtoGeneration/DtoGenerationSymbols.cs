...
{
    public INamedTypeSymbol? AutoGenerateDto, Ignore, PropertySetting, GenerateBeforeAndAfterAssignPartialsInMapping;
    public DtoGenerationConfig Config { get; private set; } = null!;
    private bool deepProperties => Config?.DeepProperties ?? false;
    ...
    public static DtoGenerationSymbols Collect(Compilation c, DtoGenerationConfig config) => new()
    {
        ...
        GenerateBeforeAndAfterAssignPartialsInMapping = c.GetTypeByMetadataName(typeof(GenerateBeforeAndAfterAssignPartialsInMappingAttribute).FullName!),
    ...
    public string[] GetUsings(INamedTypeSymbol type, Dictionary<string, INamedTypeSymbol> dtoTypeDict,
        AutoGenerateDtoAttribute autoGenAttr, DtoGenerationConfig cfg)
    {
        return GetUsings(new[] { type }, dtoTypeDict, autoGenAttr, cfg);
    }

    public string[] GetUsings(IEnumerable<INamedTypeSymbol> types, Dictionary<string, INamedTypeSymbol> dtoTypeDict,
        AutoGenerateDtoAttribute? autoGenAttr, DtoGenerationConfig cfg)
    {
