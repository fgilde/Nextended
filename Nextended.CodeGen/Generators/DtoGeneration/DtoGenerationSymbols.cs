...
public class DtoGenerationSymbols
{
    ...
    public static string GetComClassName(ITypeSymbol type, AutoGenerateDtoAttribute? attr, bool asInterface)
    {
    ...
    public static string GetToComMethodName(ISymbol type, AutoGenerateDtoAttribute? attr)
    {
    ...
    public static string GetToNetMethodName(ISymbol type, AutoGenerateDtoAttribute? attr)
    {
    ...
    public static string[] GetUsings(IEnumerable<INamedTypeSymbol> types, Dictionary<string, INamedTypeSymbol> comTypeDict, 
        AutoGenerateDtoAttribute? autoGenAttr, DtoGenerationConfig cfg )
    {
        var usings = new HashSet<string>(cfg.Usings ?? Enumerable.Empty<string>())
        {
            "System",
        };
    ...
    {
        return $"{(autoGenAttr.IsComCompatible ? "COM" : "Dto")} class for {type.Name}";
    }
